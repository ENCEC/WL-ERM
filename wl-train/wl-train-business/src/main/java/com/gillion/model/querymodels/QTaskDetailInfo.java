...
public class QTaskDetailInfo extends BaseModelExpression<TaskDetailInfo, Long> {
    ...
    public static final FieldExpression<Date> offerDate = taskDetailInfo.fieldOf("offerDate", Date.class);
    ...
    public static final FieldExpression<Long> jobStatus = taskDetailInfo.fieldOf("jobStatus", Long.class);

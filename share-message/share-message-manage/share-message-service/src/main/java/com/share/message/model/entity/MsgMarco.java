...
@SuppressWarnings("JpaDataSourceORMInspection")
    ...
    @Data
    @Entity
@Table(name = "msg_marco")
public class MsgMarco extends BaseModel implements Serializable{
private static final long serialVersionUID=1;

    /**主键*/
    @Id
    @Column(name = "msg_marco_id")
    ...
    /**宏中文*/
    @Column(name = "marco_name_cn")
    private String marcoNameCn;

    /**宏英文*/
    @Column(name = "marco_name_en")

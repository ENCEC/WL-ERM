...
public class QUemCompanyManager extends BaseModelExpression<UemCompanyManager, Long> {
    ...
    public static final BaseModelExpression<SysPlatformUser, Long> sysPlatformUser = new QSysPlatformUser(uemCompanyManager, "sysPlatformUser");
    public static final BaseModelExpression<UemCompany, Long> uemCompany = new QUemCompany(uemCompanyManager, "uemCompany");
    public static final BaseModelExpression<UemUser, Long> uemUser = new QUemUser(uemCompanyManager, "uemUser");
    public static final BaseModelExpression<UemUserCompany, Long> uemUserCompany = new QUemUserCompany(uemCompanyManager, "uemUserCompany");

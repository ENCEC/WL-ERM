...
import com.share.auth.center.model.entity.UemCompanyHistory;
...
public class QUemCompanyHistory extends BaseModelExpression<UemCompanyHistory, Long> {
    ...
    public static final BaseModelExpression<SysPlatformUser, Long> sysPlatformUser = new QSysPlatformUser(uemCompanyHistory, "sysPlatformUser");
    public static final BaseModelExpression<UemCompany, Long> uemCompany = new QUemCompany(uemCompanyHistory, "uemCompany");

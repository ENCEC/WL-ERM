...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    @Value("${redis.scanInterval}")
    private int scanInterval;

    private static final String REDISSON_HOST_STARER = "redis://";
    ...
    public RedissonClient redissonClient() {
        ...
        if (cluster) {
            ...
            Arrays.stream(nodes).forEach(v -> newNodes.add(v.startsWith(REDISSON_HOST_STARER) ? v : REDISSON_HOST_STARER + v));
            ...
            String node = hostAndPort.startsWith(REDISSON_HOST_STARER) ? hostAndPort : REDISSON_HOST_STARER + hostAndPort;

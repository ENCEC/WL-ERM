...
import com.share.auth.center.model.querymodels.QUemCustomerType;
...
public class QUemCompany extends BaseModelExpression<UemCompany, Long> {
    ...
    public static final FieldExpression<String> internationalBusinessFileUrl = uemCompany.fieldOf("internationalBusinessFileUrl", String.class);
